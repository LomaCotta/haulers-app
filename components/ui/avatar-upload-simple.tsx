...
// Simplified Image Cropper Component
...
function SimpleImageCropper({ src, cropArea, onCropAreaChange, rotation, imageRef }: SimpleImageCropperProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        {/* Simple crop overlay - just a border */}
        <div
